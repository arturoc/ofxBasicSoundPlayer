...
meta:
    ADDON_NAME = ofxBasicSoundPlayer
	ADDON_DESCRIPTION = Simple sound player using a sound stream and some libraries to decode sound formats
	ADDON_AUTHOR = Arturo Castro and Damian Stewart with contributions from Adam Carlucci, Marek Bareza and Roy McDonald,
	ADDON_TAGS = "audio" "sound"
	ADDON_URL = http://github.com/arturoc/ofxBasicSoundPlayer
